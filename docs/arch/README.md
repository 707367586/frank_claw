...
**对应 PRD:** v2.0 | **架构版本:** v4.2 | **日期:** 2026-03-18
...
| 文档 | 内容 | 阅读顺序 |
|------|------|---------|
| [architecture.md](./architecture.md) | **系统总体架构 v4.2** — 分层架构、模块职责、核心数据流、部署架构、技术栈选型 | 1 |
...
| [security-architecture.md](./security-architecture.md) | **安全架构 v4.1** — 威胁模型、三级沙箱、12 层纵深防御、DLP、审计日志 | 4 |
| [memory-architecture.md](./memory-architecture.md) | **记忆系统架构** — 三层记忆模型、艾宾浩斯衰减、语义召回、Trait 接口 | 5 |
| [autonomy-architecture.md](./autonomy-architecture.md) | **自主性架构** — Task/Trigger/Run、多步执行、权限渐进、Attention Policy | 6 |
| [api-design.md](./api-design.md) | **API 设计 v4.2** — 本地控制平面、RESTful 端点、FFI 边界 | 7 |
